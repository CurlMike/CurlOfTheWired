    ...
    <div class="text-white text-center mt-24 mb-24">
        ...
        <form method="POST" action="{{ route('user.update', ['account_name' => $user->account_name])}}" class="mt-10" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-500">This is the name that appears on your profile.</p>
            </div>
            <div class="mb-4">
                ...
                <p class="text-gray-500">This is the e-mail associated with your profile. <br>
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-500">This is your profile biography. You can use it to tell people more about your page.</p>
            </div>
            <div class="mb-4">
                ...
                <p class="text-gray-500">Public accounts are visible to anyone. Private accounts are only visible to followers. <br> Select the box if you wish to make your account private.</p>
            </div>                       
            <div class="mb-4">
                <label for="avatar" class="block mb-2 font-medium text-white text-xl">Profile Pircute</label>
                ...
                <p class="text-gray-500">This is the profile picture that appears on your profile page.</p>
            </div>
            <div class="mb-4">
                ...
                <p class="text-gray-500">This is the profile banner that appears on your profile page.</p>
            </div>
